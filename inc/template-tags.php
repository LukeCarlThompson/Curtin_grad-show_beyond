...
if ( ! function_exists( 'beyond_posted_on' ) ) :
	...
	function beyond_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'beyond' ),
...
if ( ! function_exists( 'beyond_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function beyond_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'beyond_entry_footer' ) ) :
	...
	function beyond_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			/* translators: used between list items, there is a space after the comma */
			$tags_list = get_the_tag_list( '', esc_html_x( ', ', 'list item separator', 'beyond' ) );
			if ( $tags_list ) {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'beyond' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'beyond' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'beyond_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function beyond_post_thumbnail() {
